...
def run_check() -> tuple[str, list[str]]:
    ...
    # -- follows DISPATCH_DB_BACKEND like every other notams reader.
    # Explicit AS aliases + key access (not row[0]) keep this correct under
    # both the sqlite3.Row and the postgres dict_row backends.
