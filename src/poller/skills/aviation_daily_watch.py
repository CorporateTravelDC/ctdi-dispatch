...
def main() -> None:
    ...
    try:
        ...
        ollama_result = llm_generate(
            ...
            # Same fail-fast/no-Anthropic pattern as ops_brief.py/
            # ep_advance_brief.py (2026-08-06) -- local Ollama or
            # deterministic only, never a cloud API call from this box.
