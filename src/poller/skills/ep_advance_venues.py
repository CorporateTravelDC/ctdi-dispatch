...
def _call_ollama(prompt: str) -> str | None:
    ...
    # function's own docstring; had been silently ignored even before
    # removal, since the retry body never read it). Both together made
    # every call here raise TypeError, failing this skill's every
    # scheduled 06:10 ET fire since it shipped (confirmed in the journal
    # for Sep 1-4) -- the venue-advisory half of ep-advance never once
    # succeeded on schedule. Matches ep_advance_brief.py's own (working)
    # call shape.
