...
def silence_sector(
    sector: str,
    body: SilenceRequest,
    tier: Tier = Depends(require_admin("sectors.sector.silence")),
):
...
def silence_feed(
    feed_name: str,
    body: SilenceRequest,
    tier: Tier = Depends(require_admin("sectors.feed.silence")),
):
...
def throttle_topic(
    ...
    tier: Tier = Depends(require_admin("sectors.topic.throttle")),
):
...
def enable_topic(
    topic: str,
    body: EnableRequest,
    tier: Tier = Depends(require_admin("sectors.topic.enabled")),
):
...
def sanitize_topic(
    ...
    tier: Tier = Depends(require_admin("sectors.topic.sanitize")),
):
