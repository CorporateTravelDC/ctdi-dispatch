...
| C-2 | **Critical** | `_is_trusted()` trusts client-supplied `X-Forwarded-For`/`CF-Connecting-IP` | **Live** (`XFF: 10.0.0.5` → 200 real chat data; `8.8.8.8` → 404) |
