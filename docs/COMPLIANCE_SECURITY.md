...
* **All 19 rows have `expires_at IS NULL`** (re-verified 2026-08-23 12:5x
  EDT; up from 15 on 2026-08-19 — re-query with (Postgres since the
  2026-09-20 cutover, docs/POSTGRES_MIGRATION.md; the sqlite3 form of this
  command no longer reaches live data) `psql -h /var/run/postgresql -U
  dispatch -d corporatetraveldc -c "SELECT
